...
Screenshots are always good in how-to pieces. Use them to illustrate functionality, 
show users a series of steps, or give examples.
...
because screen readers will read it as 
*Image of image of edit citation dialog box*. Try to limit alt text 
to 15 to 25 words. if you need to have a longer explanation, add it to the page as a 
description for the action involved.

When captioning an image, don't add additional context or information.
Don't just repeat what the user sees by looking at the image. 
