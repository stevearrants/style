...
example, writing *POC* instead of *Proof of Concept*, or *PAP* for
...
(abbreviations pronounced as letters, like POC). This guide refers to
...
example, *The site was our POC (Proof of Concept).*

Some acronyms are more recognizable than their full spellings. For
example, *IBM*. In such instances, the acronym is always acceptable, at
