...
will stop what they are doing and ask for guidance. Worse, some users just decide 
the first one they found is correct, or the one with the latest date, or 
the file found in a specific folder.

Consolidate. Direct the reader to the right location &mdash; ask 
someone if you aren't sure.
